...
<?php
    ...
    $empresaContato = mysqli_real_escape_string($conexao,$_POST["empresaContato"]); 
    $tipoServicoContato = mysqli_real_escape_string($conexao,$_POST["tipoServicoContato"]); 
    ...
    tipoServicoContato = '{$tipoServicoContato}',
