<?php
    ...
    $rs = mysqli_query($conexao, $sql) or die("Erro ao recuperar os dados do registro. "); 
...
<div class="row">
    ...
    <div class="col-6">
        <form class="needs-validation" action="index.php?menuop=atualizar-contato" method="post" enctype="multipart/form-data" novalidate>
            <div class="mb-3 col-3">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="idContato" value="<?=$dados["idContato"]?>" readonly required>
        ...
        <div class="row">
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="empresaContato" value="<?=$dados["empresaContato"]?>" required>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="tipoServicoContato" value="<?=$dados["tipoServicoContato"]?>" required>
                ...
                <div class="col-6">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-select" name="sexoContato" id="sexoContato" required>
                            ...
                            <option <?php echo ($dados['sexoContato']=='N')?'selected':''?> value="N"> Prefiro não informar </option>
                        </select>
            ...
            <input type="hidden" name="idContato" value="<?=$idContato?>">
                <label class="form-label" for="arquivo">Selecione um arquivo de imagem da foto</label>
                    ...
                    <div class="input-group">
                        ...
                        <input id="btn-enviar-foto" class="btn btn-secondary" type="button" value="Enviar">
                    </div>    
        </form>
